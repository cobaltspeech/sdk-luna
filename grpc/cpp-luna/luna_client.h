...
public:
    ...
    std::vector<float> synthesize(const cobaltspeech::luna::SynthesizerConfig &config,
    ...
    //! the server.
    LunaSynthesizerStream synthesizeStream(const cobaltspeech::luna::SynthesizerConfig &config,
                                           const std::string &text);
