...
_VOICE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='sample_rate', full_name='cobaltspeech.luna.Voice.sample_rate', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='language', full_name='cobaltspeech.luna.Voice.language', index=3,
...
SynthesizerConfig = _reflection.GeneratedProtocolMessageType('SynthesizerConfig', (_message.Message,), {
